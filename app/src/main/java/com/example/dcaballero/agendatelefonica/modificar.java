...
public class modificar extends AppCompatActivity {
    ...
    public void modificar_clicked(View view){
        ...
        Personas persona = new Personas(nombre_input.getText().toString(), apellido_input.getText().toString(), Integer.parseInt(edad_input.getText().toString()), Integer.parseInt(telefono_input.getText().toString()), email_input.getText().toString());
